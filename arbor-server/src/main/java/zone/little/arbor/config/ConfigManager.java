...
import zone.little.arbor.commands.CommandRegister;
import zone.little.arbor.config.flags.TransformedConfig;
...
public class ConfigManager {
    ...
    public static void initConfigs() {
        registerConfig("arbor", builder.of("arbor", "zone.little.arbor.config.modules"));
        preLoad();
    }
