...
import zone.little.arbor.functions.bars.TickableStatusBar;
import zone.little.arbor.functions.bars.impl.Membar;
import zone.little.arbor.functions.bars.impl.RegionBar;
import zone.little.arbor.functions.bars.impl.TpsBar;
...
public enum EnumBarType {
    ...
    EnumBarType(Class<? extends TickableStatusBar> clazz, String name, String commandName, String configPath, Supplier<Map<String, Object>> settingsProvider) {
        this(clazz, name, commandName, new Pair<>("arbor", configPath), settingsProvider);
    }
