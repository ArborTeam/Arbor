...
public class ForceCleanupEntityBrainMemoryConfig implements IConfigModule {
    @TransformedConfig(name = "enabled_for_entity", category = {"fixes", "enabled_for_entity"})
    ...
    @TransformedConfig(name = "enabled_for_block_pos", category = {"fixes", "enabled_for_block_pos"})
